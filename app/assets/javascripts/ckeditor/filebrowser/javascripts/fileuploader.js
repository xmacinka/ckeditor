...
qq.FileUploaderBasic = function(o){
    this._options = {
        ...
        onError: function(id, fileName, xhr) { $('.alert').html('Upload aborted: 30 second upload limit reached.<br>Please reduce the size of the image and try again.').slideDown(); },
        // messages                
        messages: {
